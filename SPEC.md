...
| BOLT-RULE-INERT | For every rule whose pattern is code (all but `escape`, `strings`, `chars`, `space`, `twice`, `foreign` and `rewalk`), changing the contents of a comment or string literal does not change the findings. | Proved | pending | bolt/rules/LAWS.bend inert_hole; bolt/rules/LAWS.bend inert_put; bolt/rules/LAWS.bend inert_tail; bolt/rules/LAWS.bend inert_pick; bolt/rules/LAWS.bend inert_strict; bolt/rules/LAWS.bend inert_doc; bolt/rules/LAWS.bend inert_param; bolt/rules/LAWS.bend inert_table; bolt/rules/LAWS.bend inert_index; bolt/rules/LAWS.bend inert_concat; bolt/rules/LAWS.bend inert_unit |
