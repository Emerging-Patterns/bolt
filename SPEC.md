...
| BOLT-RULE-C006 | `escape` reports exactly a `\0` followed by a digit in a string or char literal. | Proved | pending |  |
...
| BOLT-RULE-U005 | `nat` reports exactly a Nat literal of 1000 or more. | Proved | pending |  |
