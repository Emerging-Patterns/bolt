...
| BOLT-RULE-U004 | `concat` reports exactly a self-call argument that appends onto the parameter in its own position: the append written as the argument, inside any number of parentheses, or a lone name whose nearest `q = ..` or `+q = ..` let before the call, in its statement chain or an enclosing one, has such an append as its right side. | Proved | proved | bolt/rules/LAWS.bend concat_counts; bolt/rules/LAWS.bend concat_paren; bolt/rules/LAWS.bend concat_in_place; bolt/rules/LAWS.bend concat_via; bolt/rules/LAWS.bend concat_nearest; bolt/rules/LAWS.bend concat_other; bolt/rules/LAWS.bend concat_scope; bolt/rules/LAWS.bend concat_bound; bolt/rules/LAWS.bend concat_bound_plus |
...
| BOLT-RULE-S003 | `wrap` reports exactly one finding for each def header that breaks its shape and none otherwise: a one-line header wider than 120 columns through its last `:` (the whole header when it has none), counted as `space` counts a line, or a header across lines whose parameter list (opened by the first `(` with no bracket open, split by the commas at its own depth) holds a parameter that spans lines, starts on the `(` line, or starts on the line a later parameter starts on, or holds no parameter at all, or closes with its `)` not on a line below the last parameter's last line, or with no `->` (or, with no return type, the header's `:`) right after its `)` on the `)` line. | Proved | proved | bolt/rules/LAWS.bend wrap_width; bolt/rules/LAWS.bend wrap_shape_counts; bolt/rules/LAWS.bend wrap_counts |
...
| BOLT-CFG-4 | A finding is graded by the nearest readable bolt.bend in its file's directory, then each parent, and only that one applies. | Proved | proved | bolt/LAWS.bend absolute_root; bolt/LAWS.bend absolute_under; bolt/LAWS.bend home_empty; bolt/LAWS.bend home_here; bolt/LAWS.bend home_up; bolt/LAWS.bend home_down; bolt/LAWS.bend chain_parent; bolt/LAWS.bend nearest_grades |
...
| ID | Requirement | Level | Status | Law |
| :---- | :---- | :---- | :---- | :---- |
| BOLT-CHK-1 | `bolt check` prints one `path:line:1: error:` line per error bend reports, on the line bend marks, then a count; it exits 1 when there is any, and treats a failure to run bend as an error. | Proved | proved | bolt/LAWS.bend check_lines; bolt/LAWS.bend check_one_each; bolt/LAWS.bend check_clean; bolt/LAWS.bend check_one; bolt/LAWS.bend check_many; bolt/LAWS.bend check_unrun_error; bolt/LAWS.bend check_run_of; bolt/LAWS.bend check_run_unrun; bolt/LAWS.bend check_exec_ran; bolt/LAWS.bend check_exec_unrun; bolt/LAWS.bend check_exec_died; bolt/LAWS.bend check_exec_died_reported; bolt/LAWS.bend check_exec_untagged; bolt/LAWS.bend check_proof_unrun; bolt/LAWS.bend check_marked; bolt/LAWS.bend check_marked_line; bolt/LAWS.bend check_import_first; bolt/LAWS.bend check_own_marked |
...
| BOLT-LSP-6 | Hover, definition, references and completion answer from the binder (BOLT-SYN-5) over the open text and its relative imports. | Proved | proved | bolt/lsp/LAWS.bend nav_open_text; bolt/lsp/LAWS.bend nav_definition_binder; bolt/lsp/LAWS.bend nav_definition_local; bolt/lsp/LAWS.bend nav_definition_item; bolt/lsp/LAWS.bend nav_definition_import; bolt/lsp/LAWS.bend nav_definition_free; bolt/lsp/LAWS.bend nav_import_open; bolt/lsp/LAWS.bend nav_hover_use; bolt/lsp/LAWS.bend nav_hover_binder; bolt/lsp/LAWS.bend nav_hover_item; bolt/lsp/LAWS.bend nav_hover_own; bolt/lsp/LAWS.bend nav_references; bolt/lsp/LAWS.bend nav_completion; bolt/lsp/LAWS.bend nav_completion_import |
| BOLT-LSP-7 | Positions are in the encoding the client negotiated. | Proved | proved | bolt/lsp/LAWS.bend enc_negotiated; bolt/lsp/LAWS.bend enc_advertised; bolt/lsp/LAWS.bend enc_kept; bolt/lsp/LAWS.bend enc_round; bolt/lsp/LAWS.bend enc_sent; bolt/lsp/LAWS.bend enc_read; bolt/lsp/LAWS.bend enc_tokens; bolt/lsp/LAWS.bend enc_utf32 |
...
| BOLT-TRUST-5 | `bend <file> --check-only` never runs `main`, and prints its report in the shape `bolt/lsp/report.bend` parses, naming a def in `Location:` the way `bolt/lsp/checker/names.bend` builds its names. | bend is a separate program, and the report format has already drifted once (`report_import`). |
